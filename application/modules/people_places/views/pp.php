   ...
   <div class="container-fluid people-columns">
     ...
     <div class="people-list">
        <div class="row people-row">
          <div class="col-xs-12 col-md-6 people-item">
            <div class="row item-content">
              <div class="item-image">
                <img id="peopleimage" src="<?php echo base_url('assets/images/default-image.png'); ?>">
              </div>
   ...
   <div class="container-fluid places-columns">
     ...
     <div class="place-list">
        <div class="row places-row">
          <div class="col-xs-12 col-md-6 place-item">
            <div class="row item-content">
              <div class="item-image">
                <img id="peopleimage" src="<?php echo base_url('assets/images/default-image.png'); ?>">
              </div>
